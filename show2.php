...
require_once('replaceit_sfm2html.inc.php');
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-9 col-xl-8">
            ...
            $text = $format_sfm->to_html(sprintf('ptx/%s.sfm',$bog), $kap, $fra, $til);
            $heading = trim($format_sfm->title) . ", kapitel $format_sfm->read_chapter";
            $credit = $format_sfm->credit;
            ?>
          <div class="card mt-4">
      ...
      <?php
      $show_ref = !empty($format_sfm->references);
      $show_note = $_SESSION['showfnblock']=='on'
                && ($_SESSION['showfna']=='on' || $_SESSION['showfn1']=='on')
                && ($format_sfm->nextnumber>1 || $format_sfm->nextletter>'a');
      ?>
              ...
              <div class="offset-xl-<?= $show_note ? 0 : 2 ?> col-xl-4
                  ...
                  <div class="card mt-3">
                      ...
                      <div class="card-body biblenotes">
                          <small>
                          <?php foreach ($format_sfm->references as $v => $ref): ?>
                              <?php $format_ref = Xformatref($ref,'.',false); ?>
                              v<?= $v?>: <?= $format_ref ?><br>
                          <?php endforeach; ?>
                          </small>
                      </div>
